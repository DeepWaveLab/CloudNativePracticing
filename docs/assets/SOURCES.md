...
| 檔名 | 來源 | 取得日期 | 授權註記 |
|---|---|---|---|
| logos/kai-scheduler-icon-color.svg | https://github.com/cncf/artwork/blob/master/projects/kai-scheduler/icon/color/kai-scheduler-icon-color.svg | 2026-08-05 | CNCF artwork(Linux Foundation),社群教學用途 |
| logos/hami-icon-color.svg | https://github.com/cncf/artwork/blob/master/projects/hami/icon/color/hami-icon-color.svg | 2026-08-05 | CNCF artwork(Linux Foundation),社群教學用途 |
| logos/kubernetes-icon-color.svg | https://github.com/cncf/artwork/blob/master/projects/kubernetes/icon/color/kubernetes-icon-color.svg | 2026-08-05 | CNCF artwork(Linux Foundation),社群教學用途 |
| logos/hami-webui-icon.svg | https://github.com/Project-HAMi/HAMi-WebUI/blob/main/packages/web/public/favicon.svg | 2026-08-05 | HAMi-WebUI 官方 repo 內建圖示,社群教學用途 |
| logos/hami-webui-logo.png | https://github.com/Project-HAMi/HAMi-WebUI/blob/main/docs/logo-horizontal.png | 2026-08-06 | HAMi-WebUI 官方橫式標誌;-dark 版為本課調亮字色的衍生檔(深色模式用) |
| logos/ebpf-logo.svg | https://github.com/ebpf-io/ebpf.io-website/blob/main/src/images/logo-black.svg | 2026-08-07 | eBPF 官方站台 repo;深色底用 -dark 版(官方 logo-white.svg) |
| logos/ebpf-logo-dark.svg | https://github.com/ebpf-io/ebpf.io-website/blob/main/src/images/logo-white.svg | 2026-08-07 | 同上,官方白色版,深色模式用 |
| logos/bpftrace-logo.svg | https://github.com/bpftrace/bpftrace/blob/master/images/bpftrace_Full_Logo-Black.svg | 2026-08-07 | bpftrace 官方 repo;深色底用 -dark 版 |
| logos/bpftrace-logo-dark.svg | https://github.com/bpftrace/bpftrace/blob/master/images/bpftrace_Full_Logo-White.svg | 2026-08-07 | 同上,官方白色版,深色模式用 |
